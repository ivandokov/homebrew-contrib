#!/usr/bin/env python3
# Thanks to: https://justinoconnor.codes/2023/07/22/converting-pythons-requirements-txt-into-homebrew-formula-resources/

import requests

def generate_resource_blocks(requirements_file):
...
if __name__ == "__main__":
    resources_text = generate_resource_blocks('../phockup/requirements.txt')
